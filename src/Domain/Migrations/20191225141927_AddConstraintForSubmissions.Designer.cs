...
namespace GasWeb.Domain.Migrations
{
    ...
    [Migration("20191225141927_AddConstraintForSubmissions")]
    partial class AddConstraintForSubmissions
    {
            ...
            modelBuilder.Entity("GasWeb.Domain.PriceSubmissions.Entities.PriceSubmission", b =>
                {
                    ...
                    b.HasIndex("GasStationId", "CreatedByUserId", "SubmissionDate", "FuelType")
                        .IsUnique();
            ...
            modelBuilder.Entity("GasWeb.Domain.GasStations.Entities.GasStation", b =>
                {
                    ...
                    b.HasOne("GasWeb.Domain.Franchises.Entities.Franchise", "Franchise")
                        .WithMany()
                        .HasForeignKey("FranchiseId");
